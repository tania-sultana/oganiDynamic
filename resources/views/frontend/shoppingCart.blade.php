...
<div class="container my-5">
    ...
    @if(session('cart_message'))
        <div class="mb-3 p-2 text-white fw-bold" style="background-color:green; border-radius:4px;">
            ...
            <tr class="border-bottom">
                ...
                <td>
                    <div class="d-flex">
                        <div class="quantity bg-light p-2 d-flex text-center justify-content-center">
                            <p class="text-secondary dec-qty mb-0">-</p>
                            <p class="text-secondary qty px-2 mb-0">{{ $item->quantity }}</p>
                            <p class="text-secondary inc-qty mb-0">+</p>
                        </div>
                    </div>
                </td>
                <td>
                    <div class="d-flex flex-nowrap">
                        <p class="me-lg-5 me-sm-4 me-sm-1 mb-0 fw-bold">${{ number_format($item->product->price * $item->quantity, 2) }}</p>
                        <a href="{{ route('ogani.addToCart.delete', $item->id) }}"><i class="fa-solid fa-xmark text-secondary"></i></a>
                    </div>
                </td>
            </tr>
            @endforeach
    ...
    <div class="d-flex justify-content-between py-4">
        ...
        <button class="btn bg-light py-2 px-3"><i class="fa-solid fa-spinner me-1 fa-rotate-90"></i>UPDATE CART</button>
    </div>
    ...
    <div class="row pt-5 pb-4">
        <div class="col-lg-6 col-md-12">
            ...
            <div class="d-flex mb-5">
                <input type="text" placeholder="Enter your coupon code" class="border-lgt py-2 text-center">
                <button class="btn coupon-bg text-white fw-bold para ms-3 py-2 px-3 flex-nowrap cart-btn">APPLY COUPON</button>
            </div>
        </div>
        <div class="col-lg-6 col-md-12">
            <div class="bg-light p-4 ms-lg-2">
                ...
                <div class="d-flex justify-content-between border-bottom mb-3">
                    <p class="fw-bold send">Subtotal</p>
                    <p class="fw-bold send text-danger">${{ number_format($subtotal, 2) }}</p>
                </div>
                <div class="d-flex justify-content-between">
                    <p class="fw-bold send">Total</p>
                    <p class="fw-bold send text-danger">${{ number_format($subtotal, 2) }}</p>
                ...
                <div class="">
                    <a href="{{ route('ogani.checkout') }}" class="btn color-bg text-white fw-bold py-2 w-100 para">PROCEED TO CHECKOUT</a>
                </div>
            </div>
        </div>
    </div>
