    ...
    <div class="container screen-cls d-flex flex-column justify-content-center align-items-center">
        ...
        <div class=" container card-shadow pt-5 pb-4 ms-5 ">
            ...
            <div class=" d-flex flex-column justify-content-center align-items-center w-100">
                <form action="{{ route('register.store') }}" method="GET" class=" border-lgt w-50 p-4 "
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="exampleInputName" class="form-label ">Name</label>
                        <input type="name" placeholder="Write Your Name" class="form-control bg-light border-light p-2"
